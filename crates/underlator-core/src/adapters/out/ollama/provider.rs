...
use crate::adapters::out::http::{
    HttpClient, HttpClientConfig, HttpMethod, HttpRequest, StreamMode,
};
use crate::domain::error::CoreError;
use crate::domain::events::{GenerateProgress, InstallProgress, InstallStatus};
