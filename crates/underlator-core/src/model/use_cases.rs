...
use crate::events::{GenerateProgress, InstallProgress};
use crate::model::dto::{
...
///
/// Host создаёт сервис через [`crate::provider::create_provider`]. Поля `id`/`url`
...
mod tests {
    ...
    use crate::model::dto::{OllamaModel, StopRequest};
