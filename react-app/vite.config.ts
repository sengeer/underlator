...
export default defineConfig({
  ...
  server: {
     ...
     * Строгий порт
     *
     * @description Запрещает автоматический выбор другого порта,
     * если указанный порт занят.
     *
     * Обоснование: Строгий порт обеспечивает предсказуемость
     * и предотвращает конфликты с другими сервисами.
     *
