/**
 * @module CreateContextualPrompt
 * HOF CreateContextualPrompt для генерации промпта контекстного перевода.
 */

import { CHUNK_DELIMITER } from '../../constants';

/**
 * Высокоуровневая HOF функция для создания специализированного промпта
 ...
 * для обеспечения целостности структуры DOM дерева при переводе. Это критически важно
 * для DOM дерева, где необходимо сохранить разбиение на чанки.
 *
