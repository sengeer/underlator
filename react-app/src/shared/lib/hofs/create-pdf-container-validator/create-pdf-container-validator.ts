...
/**
 * Создает предикат валидации для проверки принадлежности выделения к PDF контейнеру
 *
 * @description Высокоуровневая HOFфункция для создания предиката валидации, который проверяет,
