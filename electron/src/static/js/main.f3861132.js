/*! For license information please see main.f3861132.js.LICENSE.txt */
(() => {
  'use strict';
  var e = {
      730: (e, t, n) => {
        ...
        function Oa(e, t, n) {
          if (Pa.current !== La) throw Error(l(168));
          Ca(Pa, t), Ca(Na, n);
        }
        function Fa(e, t, n) {
          var r = e.stateNode;
        ...
        function $a() {
          if (!Ua && null !== ja) {
            ...
            try {
              ...
              throw (null !== ja && (ja = ja.slice(e + 1)), Ke(Ze, $a), a);
            } finally {
              (bt = t), (Ua = !1);
            }
          }
        ...
        function Yl(e, t) {
          switch ((Ca(Kl, t), Ca(Ql, e), Ca(Wl, Vl), (e = t.nodeType))) {
            case 9:
            case 11:
        ...
        function ui(e, t, n, r) {
          ...
          'object' === typeof l && null !== l
            ? (a.context = zl(l))
            : ((l = Ra(t) ? za : Pa.current), (a.context = Ta(e, l))),
        ...
        function Ki(e, t, n) {
          ...
          switch ((tl(t), t.tag)) {
            ...
            case 6:
              if (e && null != t.stateNode) Oi(e, t, e.memoizedProps, r);
                ...
                if ('string' !== typeof r && null === t.stateNode)
                  throw Error(l(166));
                if (((n = ql(Kl.current)), ql(Wl.current), fl(t))) {
                  if (
                    ((r = t.stateNode),
                    (n = t.memoizedProps),
                    (r[da] = t),
            ...
            case 10:
              return Ll(t.type._context), Qi(t), null;
            case 19:
              if ((Ea(Zl), null === (o = t.memoizedState))) return Qi(t), null;
        ...
        function cs(e) {
          ...
          try {
            ...
            (bt = r), (Lu.transition = n), 0 === (6 & (Pu = t)) && $a();
          }
        }
        function fs() {
          (Ru = Mu.current), Ea(Mu);
        ...
        function vs(e, t) {
          ...
          if ((Cl(), (Pu = n), (Eu.current = r), null !== zu))
            throw Error(l(261));
        ...
        function Os(e, t, n, r, a, o) {
          ...
          if (((r = e), 'function' === typeof e)) Rs(e) && (i = 1);
            ...
            e: switch (e) {
              ...
              case N:
                return (
                  ((e = Ts(13, n, t, a)).elementType = N), (e.lanes = o), e
                );
              case z:
                return (
          ...
          switch (((t.lanes = 0), t.tag)) {
            ...
            case 1:
              return (
                (r = t.type),
                (a = t.pendingProps),
                Li(e, t, r, (a = t.elementType === r ? a : ni(r, a)), n)
              );
            case 3:
              e: {
  ...
  function g(e, t, n, a) {
    ...
    function y() {
      ...
      let e = g(),
        t = null == e ? null : e - v;
      (v = e), d && d({ action: u, location: k.location, delta: t });
    }
    function b(e) {
      let t =
  ...
  function z(e, t) {
    ...
    return (
      ...
      n
        .filter((e) => !N(e))
        .reduce((e, t) => e + (_.test(t) ? x : '' === t ? C : L), r)
    );
  }
  function T(e, t, n) {
    void 0 === n && (n = !1);
  ...
  const W = a.createContext({ outlet: null, matches: [], isDataRoute: !1 });
  const Q = a.createContext(null);
  function K() {
    return null != a.useContext(V);
  }
  function q() {
    return K() || f(!1), a.useContext(V).location;
  }
  function Y(e, t, n, l) {
    K() || f(!1);
    let { navigator: o } = a.useContext(H),
      { matches: i } = a.useContext(W),
      u = i[i.length - 1],
      s = u ? u.params : {},
  ...
  function Z(e) {
    ...
    return (
      ...
      a.createElement(W.Provider, { value: t }, r)
    );
  }
  function ee(e, t, n, r) {
    var l;
  ...
  function se(e) {
    ...
    return null == b
      ...
      : a.createElement(
          H.Provider,
          { value: d },
          a.createElement(V.Provider, { children: n, value: b })
        );
  }
  function ce(e) {
    ...
    return (
      a.Children.forEach(e, (e, r) => {
        ...
        if (e.type === a.Fragment)
          return void n.push.apply(n, fe(e.props.children, l));
        e.type !== ue && f(!1), e.props.index && e.props.children && f(!1);
        let o = {
        ...
        e.props.children && (o.children = fe(e.props.children, l)), n.push(o);
      }),
      n
    );
  }
  ...
  function ye(e) {
    let { type: t, onChange: n, defaultLanguage: r } = e;
    return (0, ve.jsxs)('div', {
      className: 'language-selector',
      children: [
        (0, ve.jsxs)('label', { children: [t, ': '] }),
        (0, ve.jsx)('select', {
          onChange: n,
          defaultValue: r,
          children: Object.entries(ge).map((e) => {
            let [t, n] = e;
            return (0, ve.jsx)('option', { value: n, children: t }, t);
          }),
        }),
      ],
    });
  ...
  function be(e) {
    var t;
    let { text: n, percentage: r } = e;
    return (
      (r = null !== (t = r) && void 0 !== t ? t : 0),
      (0, ve.jsx)('div', {
        className: 'progress-container',
        children: (0, ve.jsxs)('div', {
          className: 'progress-bar',
          style: { width: `${r}%` },
          children: [n, ' (', `${r.toFixed(2)}%`, ')'],
        }),
      })
    );
  }
  const ke = function () {
    const [e, t] = (0, a.useState)([]),
      ...
      [l, o] = (0, a.useState)('I like to translate.'),
      [i, u] = (0, a.useState)('eng_Latn'),
      [s, c] = (0, a.useState)('rus_Cyrl'),
      [f, d] = (0, a.useState)('');
    return (
      (0, a.useEffect)(() => {
        window.electron.onStatus((e) => {
          switch (e.status) {
            case 'progress':
              t((t) => [...t, e.data]);
              break;
        ...
        children: (0, ve.jsx)(ce, {
          children: (0, ve.jsx)(ue, {
            ...
            element: (0, ve.jsxs)(ve.Fragment, {
              children: [
                (0, ve.jsx)('h2', {
                  children: 'ML-powered multilingual translation in React!',
                }),
                (0, ve.jsxs)('div', {
                  className: 'container',
                  children: [
  ...
  o.createRoot(document.getElementById('root')).render(
    (0, ve.jsx)(a.StrictMode, { children: (0, ve.jsx)(ke, {}) })
  );
})();
//# sourceMappingURL=main.f3861132.js.map
