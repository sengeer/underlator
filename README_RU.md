...
### Использование предустановленной Ollama

Если у вас уже установлена и запущена Ollama, выберите провайдер **Ollama** в разделе **API конфигурация** и вручную укажите URL и модель. Примечание: провайдер Ollama отключен на macOS из-за ограничений Gatekeeper, блокирующих локальные сетевые запросы.
